...
layout: post
title:  "搭建自己的博客网站"
date:   2019-09-21 12:01:02 +1500
categories: diary 
---

今天是我的生日<img src="\assets\emoji.jpg" width="3%" height="3%" >

---

&emsp;很多时候我们会写一些博客，来分享自己得意的东西。刚好国内很多博客网站（如csdn、cnblogs等）提供了这样的一个平台，也提供了很好的功能，但是在个性化方面就差点意思。这时候我们就想到自己搭建一个博客网站。可是如果要自己买云服务器来搭建，而且还有环境部署和后期维护，一套下来整下来是挺麻烦的。不过不用慌，今天我就要介绍一种快捷方便的方式，来搭建自己的博客网站，这就是用github来写博客。

&emsp;github为每个用户提供一个“Github Pages”功能，它允许用户在Web上实时发布网站内容。现在我们就利用这个功能来建网站。
